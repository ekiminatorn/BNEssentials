...
/*
 * Credits:
 * Thanks to amhokies from GitHub.
 * 
 */
...
public class BNEBooks
{
    ...
    public BNEBooks(String title, String author, List<String> pages)
    {
        this.title = title;
        this.author = author;
        this.pages = pages;
    ...
    public static ArrayList<BNEBooks> loadBooks() throws FileNotFoundException
    {
        ArrayList<BNEBooks> books = new ArrayList<BNEBooks>();
        File[] bookSaves = BNEssentials.saveDir.listFiles();
        ...
        for (File bookSave : bookSaves)
        {
            ...
            scanner.close();
            books.add(new BNEBooks(title, author, pages));
        }
        return books;
    }
    ...
    public static void saveBook(String bookName, BookMeta data)
    {
        ...
        {
            PrintWriter writer =
                    new PrintWriter(new File(BNEssentials.saveDir, bookName
                            + ".yml"));
    ...
    public static BNEBooks getBook(String name)
    {
        for (BNEBooks book : BNEssentials.books)
        {
